...
RUN apt-get update && apt-get -y install git libffi-dev libjpeg8-dev libssl-dev libxml2-dev libxslt-dev sysstat rackspace-monitoring-agent python-dev gcc python-pip
